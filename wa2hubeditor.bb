...
; Directory Names
Global GlobalDirName$ = "GameData"; SpecialFolderLocation($1c)+"\Midnight Synergy\WA Editor"
Global AdventuresDirName$ = "Data\Adventures\"
...
Function SaveLevel()
	...
	file=WriteFile (AdventuresDirName$+AdventureFileName$+"\"+currentlevelnumber+".wlv")
...
Function LoadLevel(levelnumber)
	...
	file=ReadFile (AdventuresDirName$+AdventureFileName$+"\"+levelnumber+".wlv")
	Repeat
...
Function AdventureSelectScreen()
	...
	DisplayText2("Enter New Adventure ID (e.g. 'Adventure1')",0,3,255,255,0)
	...
	If KeyDown(28) Or KeyDown(156)
		...
		Else If FileType(AdventuresDirName$+AdventureNameEntered$)=2 
		...
		Else
			...
			CreateDir AdventuresDirName$+AdventureNameEntered$
...
Function GetCurrentAdventures()
	...
	dirfile=ReadDir(AdventuresDirName$)
	
	Repeat
		ex$=NextFile$(dirfile)
		If ex$<>"." And ex$<>".." And ex$<>"" And FileType(AdventuresDirName$+ex$)=2
...
Function StartMaster()
	...
	For i=1 To 99
		...
		MasterLevelList(i)=0
		If FileType(AdventuresDirName$+AdventureFileName$+"\"+Str$(i)+".wlv")=1
			MasterLevelList(i)=1
		EndIf
	Next
	...
	For i=1 To 999
		...
		If FileType(AdventuresDirName$+AdventureFileName$+"\"+Str$(i)+".dia")=1
	...
	If IconTextureCustom>0 
		...
		IconTextureCustom=0
	EndIf
	If FileType(AdventuresDirName$+AdventureFileName$+"\master.dat")=1
		LoadMasterFile()
...
Function LoadMasterFile()
	...
	file=ReadFile (AdventuresDirName$+AdventureFileName$+"\master.dat")
...
Function SaveMasterFIle()
	...
	file=WriteFile (AdventuresDirName$+AdventureFileName$+"\master.dat")
...
Function StartDialog()
	...
	If FileType(AdventuresDirName$+AdventureFileName$+"\"+Str$(currentdialog)+".dia")=1
		LoadDialogFile()
	Else
		ClearDialogFile()
...
Function LoadDialogFile()
	...
	; yep - load
	file=ReadFile(AdventuresDirName$+AdventureFileName$+"\"+Str$(currentdialog)+".dia")
...
Function SaveDialogFile()
	...
	file=WriteFile(AdventuresDirName$+AdventureFileName$+"\"+Str$(currentdialog)+".dia")
